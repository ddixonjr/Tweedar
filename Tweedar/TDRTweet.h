 ...
 *  @param dateString dateString  a string specifying the date of the tweet represented by the new instance of TDRTweet.
 ...
 *
 *  @return A newly initialized instance of TDRTweet.
 */
